...
class MenuLateralSeeder extends Seeder
{
    public function run(): void
    {
        DB::table('menu_lateral')->insert([
            ...
            ['id_menu' => 6, 'nombre' => 'Nota de Pieza', 'ruta' => 'nota-pieza.index', 'padre' => 5, 'icono' => null, 'ordenamiento' => 1],
            ['id_menu' => 7, 'nombre' => 'Reportes', 'ruta' => null, 'padre' => null, 'icono' => 'bx bxs-file', 'ordenamiento' => 3],
            ...
            ['id_menu' => 10, 'nombre' => 'Agrupación de Sala', 'ruta' => 'agrupacion-sala.index', 'padre' => 5, 'icono' => null, 'ordenamiento' => 2],
            ['id_menu' => 11, 'nombre' => 'Traslado a Tapiceria', 'ruta' => 'traslado-tapiceria.index', 'padre' => 5, 'icono' => null, 'ordenamiento' => 3],
            ['id_menu' => 12, 'nombre' => 'Tapizado Terminado', 'ruta' => 'tapizado-terminado.index', 'padre' => 5, 'icono' => null, 'ordenamiento' => 4],
            ['id_menu' => 13, 'nombre' => 'Disponibilidad', 'ruta' => 'reporte-disponibilidad.index', 'padre' => 7, 'icono' => null, 'ordenamiento' => 1],
        ]);
    }
}
